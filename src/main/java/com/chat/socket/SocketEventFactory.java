...
public class SocketEventFactory {
    ...
    @Autowired
    public SocketEventFactory(SocketFactory socketFactory, SocketConfig socketConfig, ChatRepository repository) {
    ...
    public SocketIOServer create() {
        ...
        socketConfig.getNamespaces().forEach(namespace -> {
            ...
            socketIONamespace.addEventListener(socketConfig.getMessageEvent(), MessageRequest.class, new SaveMessageCommand(repository, socketIONamespace, socketConfig));
        });
